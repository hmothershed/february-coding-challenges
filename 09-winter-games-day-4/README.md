# February 9th: **2026 Winter Games (Day 4: Ski Jumping)**
...
```
yourScore = distance + style + wind + kPoint
```

### Step 2: Compare Against Other Scores

1. Add your score to the list
2. Sort descending
3. Find your rank
4. Return medal based on ranked position
