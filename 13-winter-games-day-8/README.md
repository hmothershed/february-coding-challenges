...
1. Store distances in an array
2. Loop through the times
3. Compute speed → `speed = distance / time`
4. Track maximum speed and segment number
5. Round speed to 2 decimal places
6. Return speed and segment in formatted string
